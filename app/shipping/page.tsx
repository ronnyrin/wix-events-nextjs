  ...
  return (
    <div className="max-w-full-content mx-auto text-center">
      ...
      <div className="py-10 max-w-4xl mx-auto leading-7">
        ...
        <p>
          I'm the second paragraph in your Shipping Policy section. Add your own
          text and edit me to get the words just how you like. Include details
          about your policy and be sure to mention any of the important details.
          I’m a great place for you to add more information.
        </p>
        ...
        <p>
          I'm the second paragraph in your Return & Exchange policy. Add details
          about your policy and include anything you think is useful. Try to
          make the text easy to read. Let your customers know more, so they are
          well informed about their purchase and what happens if they need to
          return or exchange any items.
        </p>
      </div>
    </div>
  );
